...
def parse_node_type_aliases(plan_text: str) -> dict[str, str]:
    ...
    direct_overrides = {
        ...
        "spatial.voxel.geometry_to_blocks": "geometry.voxel.voxelize_geometry",
        "spatial.voxel.surface_strip_to_blocks": "output.execute.bake_surface_strip_to_blocks",
        "spatial.voxel.box_geometry_voxelizer": "geometry.voxel.voxelize_geometry",
        "spatial.voxel.sphere_geometry_voxelizer": "geometry.voxel.voxelize_geometry",
        "spatial.voxel.cylinder_geometry_voxelizer": "geometry.voxel.voxelize_geometry",
        "spatial.voxel.cone_geometry_voxelizer": "geometry.voxel.voxelize_geometry",
        "spatial.voxel.ellipsoid_geometry_voxelizer": "geometry.voxel.voxelize_geometry",
        "spatial.voxel.octahedron_geometry_voxelizer": "geometry.voxel.voxelize_geometry",
        "spatial.voxel.tetrahedron_geometry_voxelizer": "geometry.voxel.voxelize_geometry",
        "spatial.voxel.torus_geometry_voxelizer": "geometry.voxel.voxelize_geometry",
        "spatial.voxel.prism_geometry_voxelizer": "geometry.voxel.voxelize_geometry",
