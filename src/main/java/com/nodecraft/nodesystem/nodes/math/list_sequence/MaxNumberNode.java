...
@NodeInfo(
    ...
    id = "math.list.max_number",
    displayName = "Max Number",
    description = "Maximum of a DOUBLE_LIST.",
    category = "math.list",
    order = 38
)
public class MaxNumberNode extends BaseNode {
    ...
    public MaxNumberNode() {
        super(UUID.randomUUID(), "math.list.max_number");
        addInputPort(new BasePort(INPUT_LIST_ID, "Numbers", "Input double list", NodeDataType.DOUBLE_LIST, this));
        addOutputPort(new BasePort(OUTPUT_VALUE_ID, "Max", "Maximum value", NodeDataType.DOUBLE, this));
