...
@NodeInfo(
    ...
    description = "Constructs a semicircle profile from center, radius, plane, and segment count",
...
public class SemiCircleOnPlaneNode extends BaseNode {
    ...
    public SemiCircleOnPlaneNode() {
        ...
        addInputPort(new BasePort(INPUT_CENTER_ID, "Center", "Semicircle center point", NodeDataType.ANY, this));
        ...
        addOutputPort(new BasePort(OUTPUT_POINTS_ID, "Points", "Closed semicircle points", NodeDataType.VECTOR_LIST, this));
    ...
    public String getDescription() {
        return "Constructs a semicircle profile from center, radius, plane, and segment count";
    }
    ...
    public void processNode(@Nullable ExecutionContext context) {
        ...
        if (center == null || !(radiusObj instanceof Number rN) || !(segmentsObj instanceof Number segN)) {
            writeInvalid();
            return;
        }
