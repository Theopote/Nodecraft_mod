...
@NodeInfo(
    ...
    description = "Constructs a regular icosahedron from a center point and edge length",
...
public class IcosahedronByCenterEdgeNode extends BaseNode {
    ...
    public String getDescription() {
        return "Constructs a regular icosahedron from a center point and edge length";
    }
    ...
    public void processNode(@Nullable ExecutionContext context) {
        ...
        IcosahedronGeometryData icosahedron = new IcosahedronGeometryData(center, edge);
